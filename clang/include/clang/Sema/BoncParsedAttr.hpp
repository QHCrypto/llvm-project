...
struct ExampleAttrInfo : public ParsedAttrInfo {
  ExampleAttrInfo() {
    OptArgs = 0;
    // C/C++ standard attribute spelling.
    static constexpr Spelling S[] = {{ParsedAttr::AS_CXX11, "bonc::round"}, {ParsedAttr::AS_C2x, "bonc::round"}};
    Spellings = S;
  }
  ...
  AttrHandling handleDeclAttribute(Sema &S, Decl *D,
    ...
    D->addAttr(AnnotateAttr::Create(S.Context, "bonc_round", nullptr, 0,
                                    Attr.getRange()));
